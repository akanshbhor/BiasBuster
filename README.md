...
![API Endpoint](https://img.shields.io/badge/Backend-Hugging%20Face-yellow?logo=huggingface)

## Live Links

* **Live Demo:** [https://biasbuster-codequest26.vercel.app](https://biasbuster-codequest26.vercel.app)
* **Backend Hub:** [https://huggingface.co/spaces/AkanshGawade/BiasBuster-Backend](https://huggingface.co/spaces/AkanshGawade/BiasBuster-Backend)
* **Direct API URL:** `https://akanshgawade-biasbuster-backend.hf.space`
...
### Backend
A robust, asynchronous application designed for computationally heavy NLP and AI verification workloads.
...
3. Install Python dependencies:
   ...
   ```
4. Create a `.env` file in the `backend/` directory. *(Note: This file should be in your `.gitignore`. For production on Hugging Face, input these into the Space Settings > Secrets tab).*
   ```env
